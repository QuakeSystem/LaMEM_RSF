...
PetscErrorCode PVOutWriteLRsf        (OutVec*);
PetscErrorCode PVOutWriteStateRsf    (OutVec*);
PetscErrorCode PVOutWriteStateRsfEdge(OutVec*);
PetscErrorCode PVOutWriteVpRsf       (OutVec*);
PetscErrorCode PVOutWriteVpRsfEdge   (OutVec*);
// === debug vectors ===============================================
